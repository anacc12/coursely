<template>
    <div>
        ...
        <div class="c-login__content">
            ...
            >
                <label class="c-input__label" for="email">Email address</label>
                <b-form-input
                    type="email"
            ...
            <p class="u-type--sml">Dont have an account yet?</p>
...
export default {
    ...
    methods: {
        async login() {
            this.isLogging = true;
            const res = await this.callApi("post", "/login", this.userData);
