<template>
    <b-container fluid>
        <!--User logged in-->
        <div class="u-display--flex u-display--flex--jc--sb c-nav--aside">
            <div>
                <router-link to="/">
                    <svg
            ...
            <div class="u-display--flex u-display--flex--gap--sml">
                <!-- <div cols="1" align-self="center">
                    <div>{{ this.$store.state.currentPage }}</div>
                </div> -->

                <div
                    cols="1"
                    v-if="!isPath && $store.state.user.role != 'Student'"
                    align-self="center"
                >
                    <router-link to="/courses">
                        <Button class="c-btn c-btn--sml c-btn--primary"
                            >Courses</Button
                        >
                    </router-link>
                </div>

                <div cols="1" v-if="!isPath" align-self="center">
