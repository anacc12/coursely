<template>
    <div>
        ...
        <div
            ...
            class="c-nav c-nav--top u-display--flex u-display--flex--jc--sb"
        >
            <router-link to="/">
                <svg
            ...
            <div class="u-display--flex u-display--flex--gap--sml">
                <div>
                    <router-link to="/login">
                        <Button class="c-btn c-btn--outline c-btn--sml">
                            Log in
                        </Button>
                    </router-link>
                </div>
                <div>
                    <router-link to="/register">
                        <Button class="c-btn c-btn--primary c-btn--sml">
                            Register
                        </Button>
                    </router-link>
                </div>
        ...
        <div v-else class="c-nav--aside">
            ...
            <svg
                ...
                fill="none"
            >
                <path stroke="#F3F3F3" d="M0 1h190" />
            </svg>

            <div
                class="u-display--flex u-display--flex--col u-display--flex--gap--lrg"
            >
                <div
                    class="u-display--flex u-display--flex--col u-display--flex--gap--sml"
                >
                    <p class="u-type--decor">General</p>
                    <router-link to="/">
                        <Button
                            class="c-btn--nav"
                        ...
                        >
                            ...
                            >
                                <path
                                    stroke="#5E5E5E"
                                    stroke-width="1.3"
                                    d="M16.5 14.5a2 2 0 0 1-2 2h-11a2 2 0 0 1-2-2V9.14a2 2 0 0 1 .662-1.486l5.5-4.95a2 2 0 0 1 2.676 0l5.5 4.95a2 2 0 0 1 .662 1.487V14.5Z"
                                />
                                <path
                                    stroke="#5E5E5E"
                                    stroke-width="1.3"
                                    d="M7 16v-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v4"
                                />
                            </svg>
                            Home
                        </Button>
                        <Button class="c-btn--nav c-btn--nav--active" v-else>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="18"
                                height="18"
                    ...
                    <router-link to="/courses">
                        <Button
                            class="c-btn--nav"
                            v-if="$store.state.currentPage != 'courses'"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="18"
                            ...
                            >
                                ...
                                >
                                    <path
                                        d="M10.869 5.67c.076.713.649 1.286 1.361 1.366.529.059 1.072.11 1.626.11.553 0 1.096-.051 1.625-.11a1.549 1.549 0 0 0 1.362-1.365c.056-.526.103-1.066.103-1.616s-.047-1.09-.103-1.617a1.549 1.549 0 0 0-1.362-1.365 14.641 14.641 0 0 0-1.625-.11c-.554 0-1.097.051-1.626.11a1.549 1.549 0 0 0-1.361 1.365 15.149 15.149 0 0 0-.104 1.617c0 .55.047 1.09.104 1.616ZM1.158 5.67c.076.713.649 1.286 1.36 1.366.53.059 1.073.11 1.626.11.554 0 1.097-.051 1.626-.11A1.549 1.549 0 0 0 7.131 5.67a15.16 15.16 0 0 0 .104-1.616c0-.55-.047-1.09-.104-1.617A1.549 1.549 0 0 0 5.77 1.073a14.64 14.64 0 0 0-1.626-.11c-.553 0-1.096.051-1.625.11a1.549 1.549 0 0 0-1.361 1.365 15.16 15.16 0 0 0-.104 1.617c0 .55.047 1.09.104 1.616ZM1.158 15.562c.076.712.649 1.285 1.36 1.364.53.06 1.073.11 1.626.11.554 0 1.097-.05 1.626-.11a1.549 1.549 0 0 0 1.361-1.364 15.16 15.16 0 0 0 .104-1.617c0-.55-.047-1.09-.104-1.616a1.549 1.549 0 0 0-1.361-1.365 14.628 14.628 0 0 0-1.626-.11c-.553 0-1.096.051-1.625.11a1.549 1.549 0 0 0-1.361 1.365 15.162 15.162 0 0 0-.104 1.616c0 .55.047 1.09.104 1.617ZM10.869 15.562c.076.712.649 1.285 1.361 1.364.529.06 1.072.11 1.626.11.553 0 1.096-.05 1.625-.11a1.549 1.549 0 0 0 1.362-1.364c.056-.526.103-1.066.103-1.617 0-.55-.047-1.09-.103-1.616a1.549 1.549 0 0 0-1.362-1.365 14.63 14.63 0 0 0-1.625-.11c-.554 0-1.097.051-1.626.11a1.549 1.549 0 0 0-1.361 1.365 15.151 15.151 0 0 0-.104 1.616c0 .55.047 1.09.104 1.617Z"
                                    />
                                </g>
                                <defs>
                                    <clipPath id="a">
                ...
                <div
                    class="u-display--flex u-display--flex--col u-display--flex--gap--sml"
                >
                    <p class="u-type--decor">Learning</p>
                    <div v-if="!isPath">
                        <router-link
                            v-bind:to="'/my-courses/' + $store.state.user.id"
                        >
                            <Button
                                class="c-btn--nav"
                                ...
                                >
                                    <path
                                        ...
                                        stroke-width="1.5"
                                        d="m10.833 1.667-8.333 10H10l-.833 6.667 8.333-10H10l.833-6.667Z"
                                    /></svg
                                >My Courses</Button
                            >
                            <Button class="c-btn--nav c-btn--nav--active" v-else
                ...
                <div
                    class="u-display--flex u-display--flex--col u-display--flex--gap--sml"
                >
                    <p class="u-type--decor">Other</p>
                    <div v-if="!isPath">
                        <Button class="c-btn--nav" @click="logout()"
                            ><svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="18"
                                height="18"
                            ...
                            >
                                <path
                                    ...
                                    stroke-linejoin="round"
                                    stroke-width="1.4"
                                    d="M15.767 8.615H2M4.613 6c-1 .819-1.563 1.36-2.283 2.213a.624.624 0 0 0 0 .805c.72.854 1.284 1.394 2.283 2.213"
                                /></svg
                            >Log out</Button
                        >
                    </div>
